...
#tools
execute if score tools stage matches 1 run replaceitem entity @s[team=!] hotbar.0 minecraft:stone_sword{start:1}
execute if score tools stage matches 1 run replaceitem entity @s[team=!] hotbar.1 minecraft:stone_axe{start:1}
execute if score tools stage matches 1 unless score item_set stage matches 2 run replaceitem entity @s[team=!] hotbar.2 minecraft:stone_pickaxe{start:1}
execute if score tools stage matches 1 if score item_set stage matches 2 run replaceitem entity @s[team=!] hotbar.2 minecraft:iron_pickaxe{start:1}
execute if score tools stage matches 1 run replaceitem entity @s[team=!] hotbar.3 minecraft:stone_shovel{start:1}
execute if score lockout stage matches 2 run loot replace entity @s[team=!] hotbar.8 1 mine 0 5 0 minecraft:air{drop_contents: 1b}

replaceitem entity @s[team=!] weapon.offhand filled_map{start:1,map:1,display:{Name:'{"text":"Bingo Board","color":"dark_red","italic":false}',Lore:['{"text":"Drop me to update the board!","color":"gray","italic":false}']}} 32
